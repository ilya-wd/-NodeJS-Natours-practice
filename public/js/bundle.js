...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidXNlcm5hbWVhdiIsImEiOiJja3RicjY1eTMxczYyMnBwYzkzMXF5MmE1In0.eBaUxjWkDm2BmaaTrek1_g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/usernameav/cktbro2f5851n17k7ccvu920e',
    // using style we created in Mapboc
...
var booktTour = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51KMGnVKChg5D3f3b6Qtpe5QqQdYPEVsIkgxrOyOaQppci8VevKplOyhUF2VrN8cmuGi2L344V0L9K8eGGghY0RP500PcOyMQZ7');
            _context.prev = 1;
            _context.next = 4;
  ...
  return function booktTour(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.booktTour = booktTour;
...
var logOutBtn = document.querySelector('.nav__el--logout'); // const loginForm = document.querySelector('.login-form'); //change to '.from--login' on lecture 194?
...
if (loginForm) loginForm.addEventListener('submit', function (e) {
  ...
  e.preventDefault(); // WE can read these 2 values below only when they are defined - after the page loads - so they're defined in the email listener
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); // programmatically recreating multi-part form data

  var form = new FormData(); // appending data on that FormData object

  form.append('name', document.getElementById('name').value);
  form.append('email', document.getElementById('email').value);
  form.append('photo', document.getElementById('photo').files[0]);
  console.log(form); // Before we introduced form
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); // Giving users the feedback on progress - that sth is going on
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; // desctructuring <=> tourId = e.target.dataset.tourId

  (0, _stripe.booktTour)(tourId);
});
